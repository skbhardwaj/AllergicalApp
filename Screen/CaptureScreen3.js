...
function ObjectScannerScreen() {
  ...
  const getPrediction = async (tensor) => {
    ...
    if (prediction[0].probability > 0.3) {
      ...
      const word = prediction[0].className;
      console.log(`The object is: ${word}`);
      // setTranslation(word);
      setWord(word);
      setTranslationAvailable(true);
      ...
      <View style={styles.translationView}>
        {translationAvailable ? (
          <View>
            ...
            <Button color="#9400D3" title="Check new object" onPress={() => loadNewTranslation()} />
          </View>
        ) : (
          <ActivityIndicatorLoader size="large" />
        )}
      </View>
    );
  };
    ...
    return (
      <View style={styles.cameraView}>
        ...
        {/* <Text style={styles.legendTextField}>
          ...
          {availableLanguages.find((al) => al.value === language).label} translation
        </Text> */}
      </View>
    );
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Parse Object</Text>
      </View>
...
export default ObjectScannerScreen;
