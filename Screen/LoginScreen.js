    ...
    fetch('https://aboutreact.herokuapp.com/login.php', {
      ...
      .then((responseJson) => {
        ...
        if (responseJson.status == 1) {
          let userData = responseJson.data[0].user_id;
          userData = {
            id: '1',
            name: 'Shrikrishna',
            email: 'dummy@abc.com',
            // token: '76dd0ef5371be54647f2487524753dc66cb2a7a2',
            pic:
              'https://avatars0.githubusercontent.com/u/6456667?s=60&u=76dd0ef5371be54647f2487524753dc66cb2a7a2&v=4',
          };
          ...
          props.navigation.navigate('DrawerNavigationRoutes', { userData });
        } else {
